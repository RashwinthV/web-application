...
<?php
                        ...
                        if(isset($_POST['submit'])) {
                            ...
                            $stmt = $con->prepare("INSERT INTO organ_requests(FIRST_NAME,LAST_NAME,ORGAN_TYPE,QUANTITY,BLOOD_GROUPn,REQUEST_TYPE,ADD_RESSn,ZIP_CODE,phoneN)
                            values(?,?,?,?,?,?,?,?,?)");
                            $stmt->bind_param("sssisssis",$FIRST_NAME,$LAST_NAME,$ORGAN_TYPE,$QUANTITY,$BLOOD_GROUPn,$REQUEST_TYPE,$ADD_RESSn,$ZIP_CODE,$PhoneN);
                            $stmt->execute();
 ...
 <div class="wrapper">
    ...
    <label for="last name">Last Name</label>
      ...
      <div class="inputfield terms">
          ...
          <p><a href="#">Agreed to terms and conditions</a></p>
       </div> 
      <div class="inputfield">
