...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "CandidateAdd")) {
  $insertSQL = sprintf("INSERT INTO candidate (elesno, sturegno, canpost) VALUES (%s, %s, %s)",
           ...
           <div class="row">
               ...
               <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <form action="<?php echo $editFormAction; ?>" name="CandidateAdd" method="POST" role="form">
...
?>
                              ...
                              <input type="hidden" name="MM_insert" value="CandidateAdd">
