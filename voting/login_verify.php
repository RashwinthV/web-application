...
if (isset($_SESSION['MM_Username'])) {
  $colname_RsSelectStudents = $_SESSION['MM_Username'];
}
...
<body>
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Login Verify</h4>
                <p>&nbsp;</p>
            </div>
               ...
               <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <form action="index.php" method="POST" role="form">
                                        ...
                                        <img src="uploads/<?php echo $row_RsSelectStudents['stuthumb']; ?>">
                                        </div>
                                  
                                        <button type="submit" name="submit" id="submit" class="btn btn-info">Verify </button>
